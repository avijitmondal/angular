...
var src_app_protos_helloworld_pb = require("../../../src/app/protos/helloworld_pb");
...
Greeter.SayHello = {
  ...
  requestType: src_app_protos_helloworld_pb.HelloRequest,
  responseType: src_app_protos_helloworld_pb.HelloReply
};
